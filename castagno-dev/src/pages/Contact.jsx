...
function Field({ label, id, type = 'text', placeholder, name, required, textarea }) {
    ...
    const shared = "w-full bg-transparent text-white placeholder-slate-600 text-sm outline-none py-3 pr-3";
        ...
        >
            ...
            <div className="relative z-10 max-w-5xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-start">
                    ...
                    {/* ── COLUMNA INFO ── */}
                    <div ref={leftRef} className="opacity-0 flex flex-col gap-6 sm:gap-8">

                        <div>
                            <h3 className="text-xl sm:text-2xl font-bold text-white mb-2">¿Tenés un proyecto?</h3>
                        ...
                        {/* Redes */}
                        <div>
                            <p className="text-xs uppercase tracking-widest text-slate-600 mb-3 sm:mb-4">También en</p>
                            <div className="flex gap-3">
                                {socials.map(({ href, icon: Icon, label }) => (
                                    <a key={label} href={href} target="_blank" rel="noreferrer"
                                        className="p-2.5 sm:p-3 rounded-xl border border-slate-700/50 text-slate-400 hover:text-violet-300 hover:border-violet-500/30 transition-all duration-200"
                    ...
                    <div ref={rightRef} className="opacity-0">
                        <div
                            className="rounded-2xl border p-5 sm:p-8 flex flex-col gap-5 sm:gap-6"
                            style={{
                            ...
                            {!sent ? (
                                <form onSubmit={handleSubmit} className="flex flex-col gap-5 sm:gap-6">
                                    ...
                                    <button
                                        ...
                                        type="submit"
                                        disabled={sending}
                                        className="mt-2 flex items-center justify-center gap-3 w-full py-3 sm:py-3.5 rounded-xl font-semibold text-sm tracking-wide transition-all duration-300"
                                        style={{
                                            background: sending
                                                ? "rgba(139,92,246,0.2)"
